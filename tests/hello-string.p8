...
/
/ Modifications have been made to show off the ascii string support.
...
STRNG,  "Hello, world!\n"   / Strings are stored in consecutive memory locaions and 
                            / are null byte (0o0) terminated
